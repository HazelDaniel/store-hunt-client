	...
	return (
		<FooterStyled>
			<FooterTopStyled>
				...
				<TopRIghtStyled>
					<div className="footer-contact-title footer-section-title">CONTACT US</div>
			...
			<div className="footer-bottom">
				<p className="copyright">Copyright © 2022 SPLENDID DEPOT Co., Ltd. All Rights Reserved.</p>
