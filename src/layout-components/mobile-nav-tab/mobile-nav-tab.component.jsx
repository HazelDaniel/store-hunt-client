...
export const MobileNavTab = () => {
  ...
  return (
    <nav className="side-tab">
      <div className="nav-theme-icon-div">
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                mode="normal"
                in2="shape"
                result="effect1_innerShadow_15_540"
              />
            </filter>
      ...
      <div className="ST-navs">
        <div className="ST-title-link-div">
          <p className="ST-title-link">SHOP</p>
          <svg
            className="ST-accordion-toggle"
            viewBox="0 0 45 8"
            fill="none"
        ...
        <div className="ST-title-link-div secluded">
