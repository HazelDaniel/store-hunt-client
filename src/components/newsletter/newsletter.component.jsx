import { NewsletterStyled } from "./newsletter.styles"
...
export const Newsletter = () => {
	return (
		<NewsletterStyled>
			<div class="NLD-section-title">
				<p>SUBSCRIBE TO OUR NEWSLETTER</p>
			</div>
			<p class="NLD-title">By subscribing to our newsletter, you can get up to 30% off</p>
			<form action="">
				<input type="textbox" name="" id="" placeholder="YOUR NAME"/>
				<input type="email" name="" id="" placeholder="YOUR EMAIL"/>
				<span class="send-news-letter-cta">
			...
			<div class="newsletter-contact-div">
				<div>
					<p>email: </p>
