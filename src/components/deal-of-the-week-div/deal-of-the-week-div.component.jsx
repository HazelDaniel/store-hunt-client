...
export const DealOfTheWeek = () => {
	return (
		<DealOfTheWeekStyled>
			<div class="DOW-side-tab">
				<ul class="DOW-tab-lists">
					<li class="DOW-tab-list"><span>&rdca;</span> Clothings</li>
					<li class="DOW-tab-list active-dow-tab-list"><span>&rdca;</span> Bags</li>
					<li class="DOW-tab-list"><span>&rdca;</span> Shoe Collection</li>
				</ul>
			</div>
			<div class="DOW-item-div">
				<img src="IMAGES/product-sale-removebg-preview.png" alt="deal of the week item" class="DOW-item"/>
				<span class="DOW-item-tag">
					<p>Sale Of</p>
					<p>$150.20</p>
				</span>
				<button class="DOW-cta">
					SHOP NOW
				</button>
			</div>
			<p class="DOW-title"> deal of the week
				<span>
			...
			<p class="DOW-product-title">Multi-pocket chest bag black</p>

			<div class="DOW-time-div">
				<div class="DOW-time-count-div">
					<span>25</span>:<span>10</span>:<span>05</span>:<span>00</span>
				</div>
				<div class="DOW-time-count-label-div">
